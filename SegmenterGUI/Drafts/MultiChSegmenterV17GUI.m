...
parfor i = 1:size(NUC.filnms,2)
    ...
    [CO,Im_array] = NaiveSegmentV6(imExt,cidrecorrect,NucnumLevel,CytonumLevel,surface_segment,nuclear_segment,noise_disk,nuc_noise_disk,...
    nuclear_segment_factor,surface_segment_factor,cl_border,smoothing_factor,NucSegHeight,numCh,NUC,Cyto,i,background_corr,CorrIm_file,...
    bd_pathway,back_thresh,thresh_based_bin,im_info);
