function varargout = SegmenterV3(varargin)
% SEGMENTERV3 MATLAB code for SegmenterV3.fig
%      SEGMENTERV3, by itself, creates a new SEGMENTERV3 or raises the existing
%      singleton*.
%
%      H = SEGMENTERV3 returns the handle to a new SEGMENTERV3 or the handle to
%      the existing singleton*.
%
%      SEGMENTERV3('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEGMENTERV3.M with the given input arguments.
%
%      SEGMENTERV3('Property','Value',...) creates a new SEGMENTERV3 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before SegmenterV3_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to SegmenterV3_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help SegmenterV3

% Last Modified by GUIDE v2.5 26-Mar-2016 06:27:06

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @SegmenterV3_OpeningFcn, ...
                   'gui_OutputFcn',  @SegmenterV3_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before SegmenterV3 is made visible.
function SegmenterV3_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to SegmenterV3 (see VARARGIN)

% Choose default command line output for SegmenterV3
handles.axes1
...
% UIWAIT makes SegmenterV3 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = SegmenterV3_OutputFcn(hObject, eventdata, handles) 
...
if handles.Parallel
   MultiChSegmenterV17GUI(handles)
else
...
[handles] = ExportSegmentationV3(handles)
close(h)
guidata(hObject,handles)
